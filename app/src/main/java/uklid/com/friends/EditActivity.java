    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                values.put(FriendsContract.FriendsColumns.FRIENDS_NAME, mNameTextView.getContext().toString());
                values.put(FriendsContract.FriendsColumns.FRIENDS_PHONE, mPhoneTextView.getContext().toString());
                values.put(FriendsContract.FriendsColumns.FRIENDS_EMAIL, mEmailTextView.getContext().toString());
